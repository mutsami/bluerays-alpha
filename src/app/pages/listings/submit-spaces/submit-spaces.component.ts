...
'use strict';
@Component({
  selector: 'app-submit-spaces',
  templateUrl: './submit-spaces.component.html',
  styleUrls: ['./submit-spaces.component.css']
})
export class SubmitSpacesComponent implements OnInit {
  ...
  constructor(public auth:AuthService ,public mapServe:MapService,private uploadService: FileUploadService) { 
    this.form = new FormGroup({
      ...
      fibre: new FormControl('' ),
      lift: new FormControl('' ),
      aircon: new FormControl('' ),
      parking: new FormControl('' ),
      cctv: new FormControl('' ),
      accomodate: new FormControl('', Validators.required),
